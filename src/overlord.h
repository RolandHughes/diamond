...
public:
    ...
    QString syntaxPath()                    { return m_settings.m_options.syntaxPath();}

    KeyDefinitions &keys()                  { return m_settings.m_options.keys();}

    bool    showLineHighlight()             { return m_settings.m_showLineHighlight;}
    bool    showLineNumbers()               { return m_settings.m_showLineNumbers;}
    bool    isColumnMode()                  { return m_settings.m_isColumnMode;}
    bool    isSpellCheck()                  { return m_settings.m_isSpellCheck;}
    bool    isWordWrap()                    { return m_settings.m_isWordWrap;}
    bool    showSpaces()                    { return m_settings.m_showSpaces;}
    bool    showBreaks()                    { return m_settings.m_showBreaks;}
    bool    flagNoAutoLoad()                { return m_settings.m_flagNoAutoLoad;}
    bool    flagNoSaveConfig()              { return m_settings.m_flagNoSaveConfig;}
    ...
    bool    openedModified( int sub )       { return m_settings.m_openedModified[sub];}

    QString configFileName()                { return m_settings.m_configFileName;}

    QString advancedFindText()              { return m_settings.m_advancedFindText;}
    QString advancedFindFileType()          { return m_settings.m_advancedFindFileType;}
    QString advancedFindFolder()            { return m_settings.m_advancedFindFolder;}
    bool    advancedFSearchFolders()        { return m_settings.m_advancedFSearchFolders;}
    bool    advancedFCase()                 { return m_settings.m_advancedFCase;}
    bool    advancedFWholeWords()           { return m_settings.m_advancedFWholeWords;}
    QTextDocument::FindFlags findFlags()    { return m_settings.m_findFlags;}
    QString findText()                      { return m_settings.m_findText;}
    QString replaceText()                   { return m_settings.m_replaceText;}
    bool    findWholeWords()                { return m_settings.m_findWholeWords;}
    bool    findDirection()                 { return m_settings.m_findDirection;}
    bool    findCase()                      { return m_settings.m_findCase;}
    int     replaceListFind( QString text ) { return m_settings.m_replaceList.indexOf( text );}
    bool    printLineNumbers()              { return m_settings.m_printSettings.lineNumbers();}
    bool    printHeader()                   { return m_settings.m_printSettings.printHeader();}
    bool    printFooter()                   { return m_settings.m_printSettings.printFooter();}
    QString headerLeft()                    { return m_settings.m_printSettings.headerLeft();}
    QString headerCenter()                  { return m_settings.m_printSettings.headerCenter();}
    QString headerRight()                   { return m_settings.m_printSettings.headerRight();}
    QString headerLine2()                   { return m_settings.m_printSettings.headerLine2();}
    QString footerLeft()                    { return m_settings.m_printSettings.footerLeft();}
    QString footerCenter()                  { return m_settings.m_printSettings.footerCenter();}
    QString footerRight()                   { return m_settings.m_printSettings.footerRight();}
    QString footerLine2()                   { return m_settings.m_printSettings.footerLine2();}
    double  marginLeft()                    { return m_settings.m_printSettings.marginLeft();}
    double  marginRight()                   { return m_settings.m_printSettings.marginRight();}
    double  marginTop()                     { return m_settings.m_printSettings.marginTop();}
    double  marginBottom()                  { return m_settings.m_printSettings.marginBottom();}
    double  headerGap()                     { return m_settings.m_printSettings.headerGap();}
    QFont   printFontHeader()               { return m_settings.m_printSettings.fontHeader();}
